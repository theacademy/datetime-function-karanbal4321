...
public class DateTimeFunctions {
	...
	public static String getTimeDifference(LocalDate date1, LocalDate date2) {
		...
		int yearsDifference = timeDifference.getYears();
		int monthsDifference = timeDifference.getMonths();
		int daysDifference = timeDifference.getDays();

		return "Years" + "-" + yearsDifference + ":" + "Months" + "-" + monthsDifference + ":" + "Days" + "-" + daysDifference;
		//YOUR CODE ENDS HERE
